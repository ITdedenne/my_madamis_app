...
/** This is an auto generated class representing the ScenarioWithMyStatusConnection type in your schema. */
class ScenarioWithMyStatusConnection {
  final List<ScenarioWithMyStatus>? _items;
  final String? _nextToken;

  List<ScenarioWithMyStatus>? get items {
    return _items;
  }
  ...
  const ScenarioWithMyStatusConnection._internal({items, nextToken}): _items = items, _nextToken = nextToken;
  
  factory ScenarioWithMyStatusConnection({List<ScenarioWithMyStatus>? items, String? nextToken}) {
    return ScenarioWithMyStatusConnection._internal(
      items: items != null ? List<ScenarioWithMyStatus>.unmodifiable(items) : items,
      nextToken: nextToken);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is ScenarioWithMyStatusConnection &&
  ...
  String toString() {
    ...
    buffer.write("ScenarioWithMyStatusConnection {");
  ...
  ScenarioWithMyStatusConnection copyWith({List<ScenarioWithMyStatus>? items, String? nextToken}) {
    return ScenarioWithMyStatusConnection._internal(
  ...
  Map<String, dynamic> toJson() => {
    'items': _items?.map((ScenarioWithMyStatus? e) => e?.toJson()).toList(), 'nextToken': _nextToken
  };
